...
const Header = () => {
  ...
  const StyledBadge = styled(Badge)(() => ({
    '& .MuiBadge-badge': {
      ...
      background: scrolled ? 'var(--sec)' : 'var(--pri)',
      fontSize: scrolled ? '1rem' : '1.2rem',
      top: scrolled ? '.5rem' : '0',
      right: '-.2rem',
      color: scrolled ? 'var(--light)' : 'var(--dark)'
    },
  }));
    ...
    return (
        <>
        <TopInfo/>
        <header className={scrolled ? classes.scrolled : classes.header} >
           <div className="container">
            <div className={classes.header__container}>
                <div className={classes['header__logo-container']}>
                <Link to='/'>
                  <svg className={scrolled ? classes['scrolled-logo'] : classes.header__logo} xmlns="http://www.w3.org/2000/svg" width="163.946" height="43.146" viewBox="0 0 163.946 43.146">
              ...
              <ul className={scrolled ? classes.header__listscrolled : classes.header__list}>
                  <li className={scrolled ? classes['header__list--scrolleditem'] : classes['header__list--item']}>
                  <NavLink
              ...
              <div className={classes.header__icons}>
                <AccountCircleOutlinedIcon style={{color: scrolled ? 'var(--dark)' : 'var(--light)', fontSize: '2.3rem', cursor: 'pointer'}} />
                <StyledBadge badgeContent={4} color="primary" >
                    <LocalMallOutlinedIcon  style={{color: scrolled ? 'var(--dark)' : 'var(--light)', fontSize: '2.3rem', marginLeft: '2rem', cursor: 'pointer'}} />
                </StyledBadge>
              </div>
            </div>
           </div>
